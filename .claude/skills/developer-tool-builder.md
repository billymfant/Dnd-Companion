---
name: tool_builder
summary: Functional tool UI — calculators, generators, configurators with real utility
triggers: [tool, calculator, generator, configurator, builder, maker, create, customize, estimate, quiz]
---
