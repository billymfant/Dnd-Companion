---
name: developer-brand-app
description: Premium brand experience development. CSS architecture, state machines, 60fps animations via transform/opacity only. Use when working with: brand, activation, microsite, campaign, app, tool, generator, configurator, experience.
---
