---
name: developer-canvas-generative
description: Master-level Canvas API and creative coding. Particle systems, noise functions, force fields, orbital mechanics. 60fps always. Use when working with: particle, generative, procedural, canvas, visual, immersive, interactive, 3d, art, physics.
---
