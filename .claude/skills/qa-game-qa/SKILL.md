---
name: qa-game-qa
description: Tests games as a player first. Finds every break, softlock, and control issue. Use when working with: game, arcade, score, play, tetris, puzzle, level, lives, leaderboard.
---
